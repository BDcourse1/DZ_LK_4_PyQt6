...
class MainWindo(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        user_label.setText("Леснов Евгений")
        ...
        about_label.setText("Студент 2-го курса МАИ, М3О-236БВ-24")
        ...
        languages_label.setText("FL studio")
        ...
        developer_label.setText("Работа на студии")
